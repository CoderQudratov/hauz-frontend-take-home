# Header / Logout Related Prompt

Source: provided Claude Code prompt archive, section 1. The archive did not contain a separate standalone header/logout prompt; this shared profile-update prompt is the actual prompt that addressed the header refresh behavior.
